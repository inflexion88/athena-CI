                    ...
                    {!isConnected ? (
                        ...
                        >
                            <button
                                ...
                                className="text-red-500 text-xs tracking-[0.2em] border border-red-900/50 px-6 py-3 hover:bg-red-900/20 transition-all bg-black/80 backdrop-blur shadow-[0_0_15px_rgba(220,38,38,0.2)]"
                            >
                                TERMINATE UPLINK
                            </button>
                        </motion.div>
