        ...
        <div className="w-full max-w-[1400px] h-full relative flex flex-col justify-end p-5 md:p-10">
            ...
            <div className="absolute top-10 left-5 right-5 md:left-10 md:right-10 flex justify-between items-start pointer-events-auto">
                 ...
                 <div className="flex flex-col items-end">
                      <div className={`px-4 py-1 mb-2 font-mono text-xs font-bold tracking-widest uppercase ${
                          report.confidence.band === 'HIGH' ? 'bg-green-500 text-black' : 
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end pointer-events-auto border-t border-white/20 pt-8 relative z-10 bg-gradient-to-t from-black via-black/80 to-transparent pb-8">
                 ...
                 <div className="md:col-span-7 flex flex-col space-y-12">
                     ...
                     <div className="flex flex-col items-start text-left">
                         ...
                         <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-none">
                         ...
                         <button 
                              ...
                              className={`group flex items-center gap-3 px-6 py-3 font-mono text-xs font-bold uppercase tracking-widest transition-all relative overflow-hidden ${
