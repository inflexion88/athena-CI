   ...
   return (
      ...
      >
        ...
        @media print {
          ...
          /* COLOR LOGIC: Allow dark backgrounds with light text */
          * { 
             text-shadow: none !important; 
             -webkit-print-color-adjust: exact !important; 
             print-color-adjust: exact !important;
          }
          /* Only force black text on elements that clearly aren't styled backgrounds */
          p, h1, h2, h3, h4, span, div:not(.bg-\[\#111\]) {
             /* Default to black, but let specific overrides win */
          }
        }
      `}</style>
            ...
            <header className="h-16 bg-[#09090b] border-b border-[#222] flex items-center justify-between px-6 shrink-0 print:hidden z-20 relative">
               ...
               <div className="flex items-center gap-6">
                  <button
                     ...
                     className={`flex items-center gap-2 text-[10px] font-bold font-mono uppercase tracking-widest transition-colors ${deepDossier?.is_ready ? 'text-white hover:text-cyan-400' : 'text-gray-600 cursor-not-allowed'
                        }`}
                  >
                     ...
                     <div className="mb-12">
                        ...
                        <div className="border-y-2 border-black grid grid-cols-3 divide-x-2 divide-black">
                           ...
                           <div className="p-4">
                              ...
                              <span className={`block font-sans font-bold text-sm uppercase ${report.confidence.band === 'HIGH' ? 'text-black' :
                                       ...
                                       <div className="break-inside-avoid">
                                          ...
                                          <div className="space-y-2">
                                             {section.metrics.map((m, k) => (
                                                <div key={k} className="bg-[#111] text-white print:text-white p-4 shadow-md border-l-4 border-gray-400 break-inside-avoid">
